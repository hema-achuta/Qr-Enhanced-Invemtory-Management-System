    ...
    <div class="container">
        ...
        <div class="col-xs-3" style="text-align: center;">
            ...
            <div class="list-group">
                ...
                <a href="view_locations.php" class="list-group-item active">View Locations</a>
                <a href="add_shipper.php" class="list-group-item ">Add Location</a>
                <a href="delete_location.php" class="list-group-item ">Delete Location</a>
        ...
        <div class="col-xs-9">
            <div class="form-area" style="padding: 0px 100px 100px 100px;">
                <form action="" method="POST">
                    <br style="clear: both">
                    <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> LOCATIONS LIST </h3>
                    ...
                    $sql = "SELECT * FROM location l WHERE l.S_ID='$user_check' ORDER BY location_id";
