...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="font-size:;">IMS with QR</a>
            </div>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1>Seal the Deal,Click the Cart</h1>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <p>Components Unleashed:Fill Your Cart,Ignite Your Imagination!! <a href="foodlist.php">Order now.</a></p>
    ...
    <div class="text-center">
        ...
        <a href="genqr.php" target="_blank" class="btn btn-primary">View QR</a>
        <a href="view_action_status.php" target="_blank" class="btn btn-info btn-sm">View Status</a>
