    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" style="font-size:;"><b>IMS</b></a>
        </div>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Products</a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> IMS HELP</span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        <form
  action="https://formspree.io/f/xnqrkevp"
  method="POST">
