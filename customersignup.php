...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="shippersignup.php"> Shipper Sign-up</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="shipperlogin.php"> Shipper Sign-up</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1>Reinvent your business<br> Welcome to <span class="edit"> IMS </span></h1>
            <br>
        ...
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" action="456.php" method="POST" class="registration-form">
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="fullname"><span class="text-danger"
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="contact"><span class="text-danger"
                                                           style="margin-right: 5px;">*</span> Contact: </label>
                                <div class="input-group">
                    ...
                    <!-- Container to display QR code after generation -->
    ...
    <script>
        ...
        function registerAndGenerateQR() {
            // Execute registration form submission
            ...
            const apiUrl = `https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(generatedCode)}`;
