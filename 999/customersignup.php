...
.ate{
  ...
  font-family:  'Rubik Vinyl', cursive;
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" style="font-size:;">VIIT C<span class="ate">A</span>n<span class="ate">T</span>e<span class="ate">E</span>n</a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Foodie, <br> Welcome to <span class="edit"> VIIT Canteen </span></h1>
     <br>
