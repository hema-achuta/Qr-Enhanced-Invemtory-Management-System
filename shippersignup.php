...
<head>
  <title>Shipper Signup | IMS</title>
</head>

<link rel="stylesheet" type="text/css" href="css/shippersignup.css">
...
<body>
  ...
  <div class="container">
    <div class="jumbotron">
      <h1>Hi Shipper, <br> Welcome to <span class="edit"> IMS</span></h1>
      <br>
    ...
    <div class="col-md-5 col-md-offset-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <form role="form" action="shipper_registered_success.php" method="POST">
            ...
            <label style="margin-left: 5px;"><a href="shipperlogin.php">Have an account? Login.</a></label>
